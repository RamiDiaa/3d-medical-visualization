...
const url_2 = `https://kitware.github.io/vtk-js/data/volume/LIDC2.vti`;
const url_1 = 'https://kitware.github.io/vtk-js/data/volume/headsq.vti';
...
<table>
  <tbody>
    ...
    <tr>
     <button type="button" id="BUTTON3">Chest</button>
    </tr>
    <tr>
     <button type="button" id="BUTTON4">skull</button>    
    </tr>
  </tbody>
</table>`
// ----------------------------------------------------------------------------
...
widget1.updateStyle({
  ...
  handleWidth: 3,
  iconSize: 30, // Can be 0 if you want to remove buttons (dblClick for (+) / rightClick for (-))
  padding: 10,
});
